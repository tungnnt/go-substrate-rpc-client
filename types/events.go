...
// EventTokensEndowed is emitted when an account is created with some free balance
...
// EventCurrenciesDeposited is emitted when an account receives some free balance
